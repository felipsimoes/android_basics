    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deleteProd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder1 = new AlertDialog.Builder(ProductInfoActivity.this);
                ...
                builder1.setPositiveButton(
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                db.deleteProduct(pc);
                                Intent intent = new Intent(ProductInfoActivity.this, CatalogActivity.class);
